      ...
      <div className="container">
        ...
        <div className={`nav-wrapper ${isMenuOpen ? 'open' : ''}`}>
          <nav className="main-nav">
            <a href="/" className="active" onClick={() => setIsMenuOpen(false)}>Trang Chủ</a>
            <a href="/san-pham" onClick={() => setIsMenuOpen(false)}>Sản Phẩm</a>
            <a href="/day-chuyen" onClick={() => setIsMenuOpen(false)}>Dây Chuyền</a>
            <a href="/nhan" onClick={() => setIsMenuOpen(false)}>Nhẫn</a>
          ...
          <div className="sub-nav">
            <a href="/bo-suu-tap" onClick={() => setIsMenuOpen(false)}>Bộ Sưu Tập</a>
            <a href="/uu-dai" onClick={() => setIsMenuOpen(false)}>Ưu Đãi</a>
