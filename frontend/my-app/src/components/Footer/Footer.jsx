      ...
      <div className="footer-container" data-aos="fade-up">
        ...
        <div className="footer-col brand-info">
          ...
          <p className="brand-desc">
            Đánh thức vẻ đẹp vĩnh cửu thông qua những kiệt tác trang sức được
            chế tác thủ công tinh xảo nhất.
          </p>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            ...
            <li>
              <a href="#">Dây Chuyền Aura</a>
            </li>
            <li>
              <a href="#">Bông Tai Sapphire</a>
            </li>
            <li>
              <a href="#">Vòng Tay Moonlight</a>
            </li>
            <li>
        ...
        <div className="footer-col contact-info">
          ...
          <p>
            Tòa nhà Lumina, 123 Đường Lê Lợi, <br /> Quận 1, TP. Hồ Chí Minh
          </p>
