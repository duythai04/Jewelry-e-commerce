      ...
      <div className="story-container" data-aos="fade-right">
        ...
        <div className="story-content">
          <div className="text-wrapper">
            ...
            <h2 className="title">
              Kiệt Tác <br /> Từ Sự Tinh Tế
            </h2>
            <p className="description">
              Mỗi món trang sức tại Lumina không chỉ là vật trang sức, mà là một
              tác phẩm nghệ thuật được chế tác thủ công suốt hàng trăm giờ.
              Chúng tôi kết hợp kỹ thuật truyền thống cùng tư duy thẩm mỹ hiện
              đại để tôn vinh vẻ đẹp độc bản của bạn.
            </p>
