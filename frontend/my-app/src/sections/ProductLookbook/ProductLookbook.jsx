...
const lookbookData = {
  ...
  description:
    "Sự kết hợp hoàn hảo giữa kim cương tự nhiên và vàng trắng 18K, tạo nên vẻ đẹp thanh lịch khó cưỡng.",
  products: [
    {
      id: 1,
      ...
      <div className="lookbook-container">
        ...
        <div className="lookbook-content">
          <header data-aos="fade-left">
            <span className="sub" data-aos="fade-left">
          ...
          <button className="btn-shop-all" data-aos="fade-left">
            MUA TRỌN BỘ SƯU TẬP
          </button>
        </div>
      </div>
